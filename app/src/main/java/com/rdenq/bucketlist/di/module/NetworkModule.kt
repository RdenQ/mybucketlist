...
import com.rdenq.bucketlist.core.Config
import com.rdenq.bucketlist.data.db.AppDatabase
import com.rdenq.bucketlist.data.network.ApiService
import com.rdenq.bucketlist.data.repository.AppRepoImp
import com.rdenq.bucketlist.data.repository.AppRepository
import com.rdenq.bucketlist.data.repository.BucketCountryRepoImp
...
class NetworkModule {
    ...
    @Provides
    fun provideBucketCountryRepository(database: AppDatabase): BucketCountryRepository {
        return BucketCountryRepoImp(database)
    }
